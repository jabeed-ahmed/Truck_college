...
<body>
  ...
  $qry = "SELECT D_id from deal where s_id=(SELECT s_id from user_s where s_mail='$mail')
  and B_id=(SELECT B_id from bid where Ad_id='$ad')";
  $res12 = mysqli_query($con, $qry) or die(mysqli_error($con));
  $did = mysqli_fetch_array($res12);

  $query1 = "SELECT s_fname 'user_s', T_org_name 'user_t',  conform_date   'deal' , source_ad 'ad' , destination 'ad' , 
  price 'deal' from user_s s, deal b, user_t c, ad a
