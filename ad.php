  ...
  <section class="banner_area">
    <div class="container">
      <div class="banner_inner_text">
        <center>
          <h1> Advertisements At a Glance</h1>
        </center>
      </div>
    </div>
  </section>
    ...
    if ($res = mysqli_query($con, $sql)) {
      if (mysqli_num_rows($res) > 0) {
        while ($row = mysqli_fetch_array($res)) {
          echo '<div class="col-sm" style="background-color:#efefef;margin-top:70px; margin-bottom: 50px; margin-left:50px; margin-right:50px ;webkit-box-shadow: 1px 0px 17px 7px rgba(0,0,0,0.75);-moz-box-shadow: 1px 0px 17px 7px rgba(0,0,0,0.75); box-shadow: 1px 0px 17px 7px rgba(0,0,0,0.75);">
                <div class="col">
                  <h4 align="center">Source:</h4>
                  <h5 align="center">' . $row['luggage'] . '</h5>
                </div>
                </br>
                <div class="col">
                    <h3 align="center"> T0</h3>
                    <h3 align="center">====></h3>
                  </div>
                ...
                <div class="col">
                  ...
                  <h5 align="center">' . $row['destination'] . '</h5>
                </div>
                </br>
                <center><a href=Ad_view.php?id=' . $userId . ' class="btn btn-block btn-primary" style="margin-top:10px ; margin-bottom:10px" 
                type= "submit" name="Bid" value="Show Ad" role="button">Show Ad </a></center>
              </div>';
        }
