      ...
      <div class="col-md-5 col-xs-10 col-sm-9 center_div">
        <form class="form-container1" action="T_validate.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="password" name="password" class="form-control" placeholder="Enter your password" maxlength="50" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="type_vehicle">Type Of Vehicles *</label>
            <input type="text" name="type_vehicle" class="form-control"  placeholder="Enter the vehicle type available" required>
          </div>
          <div class="form-group">
          ...
          <div class="row">
            <div class="col-6" style="text-align:left;">
              <a href="index.php"> <code>
                  </code>Back to Home</a> </div> <div class="col-6" style="text-align:right;">
