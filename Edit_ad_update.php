...
<?php
  ...
  $query = "UPDATE ad SET Source_ad='$source',destination='$dest',
  luggage='$luggage',type_luggage='$type',weight='$weight',price='0',
  order_date='$order_date',vehicle_type='$vehicle',add_requirement='$extra' WHERE Ad_id='$ad' 
